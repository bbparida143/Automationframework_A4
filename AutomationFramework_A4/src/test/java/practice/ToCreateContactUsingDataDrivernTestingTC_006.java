...
public class ToCreateContactUsingDataDrivernTestingTC_006 {

	public static void main(String[] args) throws IOException {

		// TO READ THE DATA FROM THE PROPERTY FILE("common data ")
		...
		// TO READ THE DATA FROM EXCEL FILE("test specific data")
