...
public class ToSelectChemicalsInIndustryDropDownTC_003 {
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@name='accountname']")).sendKeys("cspiders");
		...
		System.out.println("chemicals was selected from industry dropdown");
